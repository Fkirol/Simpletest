...
class Post(models.Model):
    ...
    featured_image = models.CharField(max_length=200,default="http://media.cubadebate.cu/wp-content/gallery/autores/oscar-figueredo-reinaldo.jpg",null=True, blank=True)
